    ...
    <b-modal id="modal-blockcode" size="xl" title="Pipeline block code" v-model="show">
                ...
                <b-row>
                    <b-col>
                        <b-form-group id="input-group-1" label="Namespace:" label-for="namespace">
                            <b-form-input id="namespace" v-model="namespace" required placeholder="Enter namespaces"></b-form-input>
                        </b-form-group>
                    </b-col>
                    <b-col>
                        <b-form-group id="input-group-2" label="Pipeline Block Name:" label-for="blockName">
                            <b-form-input id="blockName" v-model="blockName" required placeholder="Enter the name for the block"></b-form-input>
                        </b-form-group>
                    </b-col>
                </b-row>
        ...
        <div>
            ...
            <div class="bd-clipboard">
                <b-button class="btn-clipboard" v-b-tooltip.hover title="Copy to clipboard" v-clipboard:copy="pipelineBlockCode" v-clipboard:success="onCopy" v-clipboard:error="onError">Copy</b-button>
            </div>
        ...
        <div>
            ...
            <div class="bd-clipboard">
                <b-button class="btn-clipboard" v-b-tooltip.hover title="Copy to clipboard" v-clipboard:copy="configureSitecoreCode" v-clipboard:success="onCopy" v-clipboard:error="onError">Copy</b-button>
            </div>
            <pre v-highlightjs='configureSitecoreCode'><code class="c#"></code></pre>
        </div>
        <div slot="modal-footer">
            <b-button variant="primary" size="sm" class="float-right btn-danger" @click="show=false">
                Close
            </b-button>
        </div>
    </b-modal>
...
.timeline-centered .timeline-entry.finish .timeline-entry-inner .timeline-label {
    background-color: #fafafa;
}

.timeline-centered .timeline-entry.start .timeline-entry-inner .timeline-label h2,
.timeline-centered .timeline-entry.finish .timeline-entry-inner .timeline-label h2 {
    color: #a0a0a0;
}
